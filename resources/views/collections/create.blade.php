            ...
            <form method="POST" action="{{ route('collections.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group ">
                        <input type="file" class="form-control form-control-sm col-md-10 h-50 w-50" name="image" placeholder="image link">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group ">
                        <input type="text" class="form-control form-control-sm col-md-10 h-50 w-50" name="description" placeholder="description">
